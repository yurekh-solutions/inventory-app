...
const blogSchema = new mongoose.Schema({
  ...
  status: { type: String, enum: ['planned', 'generating', 'draft', 'scheduled', 'published', 'failed'], default: 'draft' },
  scheduledPublishDate: { type: Date, default: null },
  publishedAt: { type: Date, default: null },
  trendKeyword: { type: String, default: '' },
  trendSource: { type: String, default: '' },
  campaignId: { type: String, default: '' },
  dayIndex: { type: Number, default: 0 },
  autoPublish: { type: Boolean, default: true },
  generationMode: { type: String, default: 'jit' },
  ...
  generationStatus: { type: String, enum: ['planned', 'generating', 'ready', 'failed'], default: 'planned' },
